...
$sql = "SELECT Op, titulo, CONVERT(varchar, fechaDesde, 105) AS fechaDesde, CONVERT(varchar, fechaHasta, 105) AS fechaHasta, horaDesde, horaHasta, color FROM tblAgenda WHERE tipo = ?";
$params = array($tipo);
